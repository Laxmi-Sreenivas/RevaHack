          ...
          children: <Widget>[
            Stack(
              children: <Widget>[
                ...
                Container(padding: EdgeInsets.fromLTRB(60, 90, 60, 0),
                    child: 
                      Center(
            ...
            Container(
              ...
              child: ElevatedButton(
                style: ButtonStyle(
                  ...
                  backgroundColor: MaterialStateProperty.all(Color.fromARGB(255, 17, 98 , 255),),
                  shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                    RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(12.0),
                      side: BorderSide(color: Color.fromARGB(0, 17, 98 , 255),width: 1),
                    )
                  )
                ),
            ...
            Row(
              ...
              children: <Widget>[
                const Text('Not Registered?',style: TextStyle(fontSize: 12),),
                TextButton(
                  child: const Text(
                    'Register Now',
